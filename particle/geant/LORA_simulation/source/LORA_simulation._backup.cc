...
int main(int argc,char** argv)
{
   ...
   //LORAPrimaryGeneratorAction* gen_action = new LORAPrimaryGeneratorAction("gamma",0.1,0.3,4.0*GeV);
      ...
      if (myfile.is_open())
      {
         ...
         //for (int i=0; i<1000; i++)
         {
            ...
            if (nextParticle!="ignore" && DistBin<nobins) {
               ...
               gen_action->SetNewParticle(nextParticle,zenith,azimuth,energy*GeV);
